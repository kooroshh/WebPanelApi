                ...
                <table class="ui celled table">
                    ...
                    @foreach(\App\Service::all() as $service)
                        <tr>
                            ...
                            <td><a data-id="{{$service['id']}}" data-name="{{$service['name']}}"  data-index="{{$service->index}}" data-enabled="{{$service->is_enabled}}"  data-recommended="{{$service->recommended}}" class="edit" href="#">Edit</a>&nbsp;|&nbsp;<a data-id="{{$service['id']}}" class="del" href="#">Delete</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
    ...
    <script>
        $(document).ready(()=>{
            ...
            $(".edit").click((e)=>{
                ...
                let recommended = $(e.target).data('recommended');
                $("#edit").val(name);
                $("#index").val(index);
                if(is_enabled =='1'){
                ...
                if(recommended =='1'){
                    ...
                    $("#recommended").removeProp('checked');
                ...
                $('#EditModal').modal({
                    ...
                    onApprove : function() {
                        let id = $(e.target).data('id');
                        editRecord(id,$("#edit").val(),$("#index").val(), $("#enabled").prop('checked'),$("#recommended").prop('checked'));
                    }
                }).modal('show');
                e.preventDefault();
            });
